        ...
        <div class="flex justify-center gap-5 pt-5">
          {bagOptions.map(bag => (
            <div
              ...
              class={`cursor-pointer p-4 ${selectedBagId() === bag.id ? 'ring-2 ring-white' : ''}`}
            >
